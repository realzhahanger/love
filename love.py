...
st.title("💌 Интерактивное письмо любви")
...
love_lines = [
    "Привет, любимый(ая)... ❤️",
    "Я давно хотел(а) сказать тебе кое-что важное...",
    ...
    "С тобой я чувствую себя настоящим(ей).",
...
if st.session_state.step == len(love_lines):
    st.balloons()
    st.success("Письмо окончено, но чувства только начинаются 💕")
